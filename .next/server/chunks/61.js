...
exports.modules = {
  ...
  /***/ 4643: /***/ (module, exports, __webpack_require__) => {
    "use strict";
    ...
    function getDomainLocale(path, locale, locales, domainLocales) {
      if (true) {
        const normalizeLocalePath =
          __webpack_require__(2554).normalizeLocalePath;
  ...
  /***/ 9749: /***/ (module, exports, __webpack_require__) => {
    "use strict";
    ...
    var _interop_require_default =
      __webpack_require__(2845) /* ["default"] */.Z;
    var _interop_require_wildcard =
      __webpack_require__(9402) /* ["default"] */.Z;
    var _object_without_properties_loose =
      __webpack_require__(8774) /* ["default"] */.Z;
  ...
  /***/ 2554: /***/ (module, exports, __webpack_require__) => {
    "use strict";
    ...
    class Router {
        ...
        return _async_to_generator(function* () {
          ...
          if (true) {
            ...
            if (localePathResult.detectedLocale) {
              ...
              parsedAs.pathname = (0, _addBasePath).addBasePath(
                parsedAs.pathname,
              );
              as = (0, _formatUrl).formatWithValidation(parsedAs);
              url = (0, _addBasePath).addBasePath(
                (0, _normalizeLocalePath).normalizeLocalePath(
                  (0, _hasBasePath).hasBasePath(url)
                    ? (0, _removeBasePath).removeBasePath(url)
                    : url,
                  _this.locales,
                ).pathname,
              );
            ...
            if (true) {
              ...
              if (
                !((ref = _this.locales) == null
                  ? void 0
                  : ref.includes(nextState.locale))
              ) {
                parsedAs.pathname = (0, _addLocale).addLocale(
                  parsedAs.pathname,
                  nextState.locale,
                );
                handleHardNavigation({
      ...
      constructor(
        ...
        if (true) {
          ...
          this.isLocaleDomain = !!(0, _detectDomainLocale).detectDomainLocale(
            domainLocales,
