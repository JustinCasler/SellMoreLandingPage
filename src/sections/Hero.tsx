...
export const Hero: React.FC<{ onScrollToPricing: () => void }> = ({
  onScrollToPricing,
}) => {
  return (
    <Section className="items-center justify-center min-h-screen 2xl:min-h-[1000px] h-fit gap-16 col md:flex-row">
      <div className="z-10 gap-4 text-center col md:text-left">
        ...
        <Details>
          A no code way to increase brand trust and sales. A tool that will pay
